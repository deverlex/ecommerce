...
public class CategoryServiceImpl implements CategoryService {
	...
	@Override
	public ResponseWrapper getLinkCategories(String category) {
		...
		return new ResponseWrapper<ListCategoryResp>(BaseStatus.OK, BaseCode.OK, "")
				.setData(new ListCategoryResp(categoriesJson));
	}

	@Override
	public ResponseWrapper getCompanyLinkCategories(long companyId, String category) {
		List<CategoryWrapper> categoriesJson = new LinkedList<>();
